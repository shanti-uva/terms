...
gem 'kmaps_engine',               '6.5.3',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.5.3' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.5.8',        github: 'shanti-uva/shanti_integration',   tag: 'v3.5.8' #path: '../engines/shanti_integration'
...
gem 'subjects_integration',       '0.3.2',        github: 'shanti-uva/subjects_integration', tag: 'v0.3.2' #path: '../engines/subjects_integration'
gem 'terms_engine',               '1.2.5',        github: 'shanti-uva/terms_engine',         tag: 'v1.2.5' #path: '../engines/terms_engine'
