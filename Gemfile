...
gem 'kmaps_engine',               '5.7.2',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.7.2' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.4.8',        github: 'shanti-uva/terms_engine',         tag: 'v0.4.8' #path: '../engines/terms_engine'
