...
gem 'authenticated_system',       '2.5.3',        github: 'thl/authenticated_system',        tag: 'v2.5.3' #path: '../../thl/engines/authenticated_system'
...
gem 'terms_engine',               '1.9.7',        github: 'shanti-uva/terms_engine',         tag: 'v1.9.7' #path: '../engines/terms_engine'
