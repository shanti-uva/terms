...
gem 'dictionary_to_terms',        '0.2.8',        github: 'shanti-uva/dictionary_to_terms',  tag: 'v0.2.8' #path: '../engines/dictionary_to_terms'
...
gem 'kmaps_engine',               '5.5.8',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.5.8' #path: '../engines/kmaps_engine'
