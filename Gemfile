...
gem 'kmaps_engine',               '5.8.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.8.1' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.5.9',        github: 'shanti-uva/terms_engine',         tag: 'v0.5.9' #path: '../engines/terms_engine'
