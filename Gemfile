...
gem 'dictionary_to_terms',        '0.4.0',        github: 'shanti-uva/dictionary_to_terms',  tag: 'v0.4.0' #path: '../engines/dictionary_to_terms'
...
gem 'terms_engine',               '0.6.8',        github: 'shanti-uva/terms_engine',         tag: 'v0.6.8' #path: '../engines/terms_engine'
