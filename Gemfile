...
gem 'flare',                      '1.4.2',        github: 'shanti-uva/flare',                tag: 'v1.4.2' #path: '../engines/flare'
gem 'kmaps_engine',               '6.8.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.8.1' #path: '../engines/kmaps_engine'
