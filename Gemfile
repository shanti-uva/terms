...
gem 'kmaps_engine',               '6.1.0',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.1.0' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.7.8',        github: 'shanti-uva/terms_engine',         tag: 'v0.7.8' #path: '../engines/terms_engine'
