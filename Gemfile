...
gem 'kmaps_engine',               '6.6.9',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.6.9' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.5.7',        github: 'shanti-uva/terms_engine',         tag: 'v1.5.7' #path: '../engines/terms_engine'
