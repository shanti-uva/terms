...
gem 'kmaps_engine',               '5.2.9',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.2.9' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.2.9',        github: 'shanti-uva/terms_engine',         tag: 'v0.2.9' #path: '../engines/terms_engine'
