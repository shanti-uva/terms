...
gem 'kmaps_engine',               '5.8.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.8.4' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.6.5',        github: 'shanti-uva/terms_engine',         tag: 'v0.6.5' #path: '../engines/terms_engine'
