...
gem 'complex_dates',              '2.4.1',        github: 'thl/complex_dates',               tag: 'v2.4.1' #path: '../../thl/engines/complex_dates'
...
gem 'kmaps_engine',               '6.6.8',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.6.8' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.5.6',        github: 'shanti-uva/terms_engine',         tag: 'v1.5.6' #path: '../engines/terms_engine'
