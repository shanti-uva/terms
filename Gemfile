...
gem 'kmaps_engine',               '6.7.3',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.7.3' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.6.0',        github: 'shanti-uva/terms_engine',         tag: 'v1.6.0' #path: '../engines/terms_engine'
