...
gem 'kmaps_engine',               '6.7.8  ',      github: 'shanti-uva/kmaps_engine',         tag: 'v6.7.8' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.6.4',        github: 'shanti-uva/terms_engine',         tag: 'v1.6.4' #path: '../engines/terms_engine'
