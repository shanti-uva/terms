...
gem 'flare',                      '1.3.4',        github: 'shanti-uva/flare',                tag: 'v1.3.4' #path: '../engines/flare'
...
gem 'terms_engine',               '0.9.6',        github: 'shanti-uva/terms_engine',         tag: 'v0.9.6' #path: '../engines/terms_engine'
