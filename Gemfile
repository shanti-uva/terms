...
gem 'kmaps_engine',               '6.0.3',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.0.3' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.7.5',        github: 'shanti-uva/terms_engine',         tag: 'v0.7.5' #path: '../engines/terms_engine'
