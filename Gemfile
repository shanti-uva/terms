...
gem 'kmaps_engine',               '6.8.6',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.8.6' #path: '../engines/kmaps_engine'
...
gem 'shanti_integration',         '3.6.2',        github: 'shanti-uva/shanti_integration',   tag: 'v3.6.2' #path: '../engines/shanti_integration'
...
gem 'terms_engine',               '1.7.8',        github: 'shanti-uva/terms_engine',         tag: 'v1.7.8' #path: '../engines/terms_engine'
