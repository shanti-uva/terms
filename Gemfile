...
gem 'kmaps_engine',               '6.6.3',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.6.3' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.3.7',        github: 'shanti-uva/terms_engine',         tag: 'v1.3.7' #path: '../engines/terms_engine'
