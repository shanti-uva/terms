...
gem 'places_integration',         '2.2.6',        github: 'thl/places_integration',          tag: 'v2.2.6' #path: '../../thl/engines/places_integration'
...
gem 'terms_engine',               '1.2.9',        github: 'shanti-uva/terms_engine',         tag: 'v1.2.9' #path: '../engines/terms_engine'
