...
gem 'kmaps_engine',               '6.1.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.1.1' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.7.9',        github: 'shanti-uva/terms_engine',         tag: 'v0.7.9' #path: '../engines/terms_engine'
