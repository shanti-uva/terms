...
gem 'subjects_integration',       '0.3.1',        github: 'shanti-uva/subjects_integration', tag: 'v0.3.1' #path: '../engines/subjects_integration'
gem 'terms_engine',               '1.1.4',        github: 'shanti-uva/terms_engine',         tag: 'v1.1.4' #path: '../engines/terms_engine'
