...
gem 'dictionary_to_terms',        '0.2.7',        github: 'shanti-uva/dictionary_to_terms',  tag: 'v0.2.7' #path: '../engines/dictionary_to_terms'
...
gem 'kmaps_engine',               '5.4.6',        github: 'shanti-uva/kmaps_engine',         branch: 'add-related-subjects-assets-popover/MANU-5371/drc2r' #tag: 'v5.3.9' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.3.5',        github: 'shanti-uva/terms_engine',         branch: 'add-definition-details-hide-show-toggle/MANU-5338/drc2r' #tag: 'v0.3.5' #path: '../engines/terms_engine'
