...
gem 'dictionary_to_terms',        '0.3.3',        github: 'shanti-uva/dictionary_to_terms',  tag: 'v0.3.3' #path: '../engines/dictionary_to_terms'
...
gem 'kmaps_engine',               '5.6.3',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.6.3' #path: '../engines/kmaps_engine'
