...
gem 'kmaps_engine',               '5.2.8',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.2.8' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.2.8',        github: 'shanti-uva/terms_engine',         tag: 'v0.2.8' #path: '../engines/terms_engine'
