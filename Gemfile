...
gem 'complex_scripts',            '3.1.9',        github: 'thl/complex_scripts',             tag: 'v3.1.9' #path: '../../thl/engines/complex_scripts'
...
gem 'flare',                      '1.4.1',        github: 'shanti-uva/flare',                tag: 'v1.4.1' #path: '../engines/flare'
gem 'kmaps_engine',               '6.7.9',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.7.9' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.6.5',        github: 'shanti-uva/terms_engine',         tag: 'v1.6.5' #path: '../engines/terms_engine'
