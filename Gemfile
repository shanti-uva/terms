...
gem 'complex_scripts',            '3.0.4',        github: 'thl/complex_scripts',             tag: 'v3.0.4' #path: '../../thl/engines/complex_scripts'
gem 'dictionary_to_terms',        '0.1.5',        github: 'shanti-uva/dictionary_to_terms',  tag: 'v0.1.5' #path: '../engines/dictionary_to_terms'
...
gem 'terms_engine',               '0.1.3',        github: 'shanti-uva/terms_engine',         tag: 'v0.1.3' #path: '../engines/terms_engine'
