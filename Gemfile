...
gem 'kmaps_engine',               '6.4.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.4.4' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.9.9',        github: 'shanti-uva/terms_engine',         tag: 'v0.9.9' #path: '../engines/terms_engine'
