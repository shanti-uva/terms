...
gem 'kmaps_engine',               '5.6.7',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.6.7' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.4.4',        github: 'shanti-uva/terms_engine',         tag: 'v0.4.4' #path: '../engines/terms_engine'
