...
gem 'dictionary_to_terms',        '0.2.2',        github: 'shanti-uva/dictionary_to_terms',  tag: 'v0.2.2' #path: '../engines/dictionary_to_terms', branch: 'recordings-importation/MANU-4955/drc2r'
...
gem 'kmaps_engine',               '5.2.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.2.4' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.2.6',        github: 'shanti-uva/terms_engine',         tag: 'v0.2.6' #path: '../engines/terms_engine'
