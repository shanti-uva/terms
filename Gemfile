...
gem 'kmaps_engine',               '6.4.6',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.4.6' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.0.1',        github: 'shanti-uva/terms_engine',         tag: 'v1.0.1' #path: '../engines/terms_engine'
