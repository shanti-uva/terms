...
gem 'dictionary_to_terms',        '0.1.7',        github: 'shanti-uva/dictionary_to_terms',  tag: 'v0.1.7' #path: '../engines/dictionary_to_terms'
...
gem 'kmaps_engine',               '5.0.5',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.0.5' #path: '../engines/kmaps_engine'
