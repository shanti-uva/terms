...
gem 'kmaps_engine',               '6.3.1',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.3.1' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.8.5',        github: 'shanti-uva/terms_engine',         tag: 'v0.8.5' #path: '../engines/terms_engine'
