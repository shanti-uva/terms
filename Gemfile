...
gem 'kmaps_engine',               '6.6.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.6.4' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.4.3',        github: 'shanti-uva/terms_engine',         tag: 'v1.4.3' #path: '../engines/terms_engine'
