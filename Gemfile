...
gem 'complex_scripts',            '3.0.8',        github: 'thl/complex_scripts',             tag: 'v3.0.8' #path: '../../thl/engines/complex_scripts'
...
gem 'terms_engine',               '0.4.1',        github: 'shanti-uva/terms_engine',         tag: 'v0.4.1' #path: '../engines/terms_engine'
