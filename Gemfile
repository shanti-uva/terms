...
gem 'kmaps_engine',               '6.0.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.0.4' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.7.6',        github: 'shanti-uva/terms_engine',         tag: 'v0.7.6' #path: '../engines/terms_engine'
