...
gem 'complex_scripts',            '3.0.3',        github: 'thl/complex_scripts',             tag: 'v3.0.3' #path: '../../thl/engines/complex_scripts'
gem 'dictionary_to_terms',        '0.1.3',        github: 'shanti-uva/dictionary_to_terms',  tag: 'v0.1.3' #path: '../engines/dictionary_to_terms'
...
gem 'kmaps_engine',               '5.0.4',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.0.4' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.1.2',        github: 'shanti-uva/terms_engine',         tag: 'v0.1.2' #path: '../engines/terms_engine'
