...
gem 'kmaps_engine',               '6.7.7',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.7.7' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.6.3',        github: 'shanti-uva/terms_engine',         tag: 'v1.6.3' #path: '../engines/terms_engine'
