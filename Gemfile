...
gem 'kmaps_engine',               '6.6.5',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.6.5' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.5.2',        github: 'shanti-uva/terms_engine',         tag: 'v1.5.2' #path: '../engines/terms_engine'
