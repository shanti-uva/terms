...
gem 'kmaps_engine',               '7.0.7',        github: 'shanti-uva/kmaps_engine',         tag: 'v7.0.7' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '2.1.0',        github: 'shanti-uva/terms_engine',         tag: 'v2.1.0' #path: '../engines/terms_engine'
