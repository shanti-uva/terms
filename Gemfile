...
gem 'kmaps_engine',               '7.0.2',        github: 'shanti-uva/kmaps_engine',         tag: 'v7.0.2' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '2.0.8',        github: 'shanti-uva/terms_engine',         tag: 'v2.0.8' #path: '../engines/terms_engine'
