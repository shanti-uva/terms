...
gem 'dictionary_to_terms',        '0.3.6',        github: 'shanti-uva/dictionary_to_terms',  tag: 'v0.3.6' #path: '../engines/dictionary_to_terms'
...
gem 'kmaps_engine',               '5.7.7',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.7.7' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.5.2',        github: 'shanti-uva/terms_engine',         tag: 'v0.5.2' #path: '../engines/terms_engine'
