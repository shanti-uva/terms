...
gem 'kmaps_engine',               '5.6.9',        github: 'shanti-uva/kmaps_engine',         tag: 'v5.6.9' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '0.4.7',        github: 'shanti-uva/terms_engine',         tag: 'v0.4.7' #path: '../engines/terms_engine'
