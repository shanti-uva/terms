...
gem 'kmaps_engine',               '6.6.7',        github: 'shanti-uva/kmaps_engine',         tag: 'v6.6.7' #path: '../engines/kmaps_engine'
...
gem 'terms_engine',               '1.5.5',        github: 'shanti-uva/terms_engine',         tag: 'v1.5.5' #path: '../engines/terms_engine'
